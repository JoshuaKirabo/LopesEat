...
const Question17 = ({ navigation }) => 
    {
        ...
        const options = 
            [
                { label: 'Not often, I am not big on sweets🚫', value: 'rarely' },
                { label: '3 - 5 times a week🍪', value: 'semi-regularly' },
                { label: 'Pretty much everyday🤤', value: 'daily' },
            ];
        ...
        return (
            ...
            <View style={styles.content}>
                    <Text style={styles.questionText}>How often do you eat or drink sugary foods or beverages?</Text>
