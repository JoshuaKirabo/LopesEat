  ...
  const handleSubmit = () => 
    {
        ...
        if (Object.values(selectedAllergies).some((id) => id)) 
            {
              saveAnswer(15, selectedAllergies);
    ...
    const handleSelection = (value) => 
      ...
      What items would you like us to exclude from your meal plan
    </Text>
    ...
    />
       ...
       I am not allergic to any of these, I just want to exclude these from my diet. If none, select 'None'
      </Text>
