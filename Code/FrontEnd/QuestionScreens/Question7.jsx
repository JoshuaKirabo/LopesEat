...
const Question7 = ({ navigation }) => {
  ...
  const options = [
    { label: 'Almost Everyday 🔥', value: 'almost-every-day' },
    { label: 'Several Times per Week 🏋️‍♂️', value: 'several-times-a-week' },
    { label: 'Several Times per Month 💪', value: 'several-times-a-month' },
