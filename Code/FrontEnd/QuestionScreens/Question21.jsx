    ...
    <View style={styles.header}>
      ...
      <View style={styles.content}>
        <Text style={styles.questionText}>
          I usually do other things while I eat (watch TV, scroll through social media)
        </Text>
