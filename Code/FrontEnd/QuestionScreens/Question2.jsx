...
const Question2 = ({ navigation }) => {
    ...
    const [physicalBuildOptions, setPhysicalBuildOptions] = useState([]);
    const { saveAnswer } = useAnswers();
    const totalQuestions = 31; // Total number of questions
    ...
    useEffect(() => {
      if (userGender === 'Male') {
        ...
        setPhysicalBuildOptions([
          { label: 'Slim', value: 'slim', image: require('../Images/women/slim.png') },
          { label: 'Mid-sized', value: 'midsized', image: require('../Images/women/mid-sized.png') },
          { label: 'On a heavier side', value: 'on_a_heavier_side', image: require('../Images/women/on-a-heavier-side.png') },
          { label: 'Overweight', value: 'overweight', image: require('../Images/women/overweight.png') },
        ]);
      }
    }, [userGender]);
