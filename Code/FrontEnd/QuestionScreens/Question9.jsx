...
const Question9 = ({ navigation }) => 
    {
        ...
        const options = 
            [
                { label: 'Almost every day 😎', value: 'almost_every_day' },
                { label: '3-4 times per week 💪', value: '3_4_times_a_week' },
                { label: '1-2 times per week 🙂', value: '1_2_times_a_week' },
                { label: 'More like once a month 👍', value: 'once_a_month' },
            ];
        ...
        return (
            ...
            <View style={styles.content}>
                    <Text style={styles.questionText}>How often do you go for walks?</Text>
