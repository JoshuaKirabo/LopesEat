...
<View style={styles.progressBarContainer}>
    ...
    <View style={styles.header}>
      ...
      <View style={styles.content}>
        ...
        One unhealthy choice makes me feel a disappointment, which causes me to make more bad choices
        </Text>
        ...
        <View style={styles.optionsContainer}>
          {Array.from({ length: 5 }, (_, i) => (
            <TouchableOpacity
              key={i + 1}
              style={
                [styles.option,selectedValue === i + 1 ? styles.selectedOption : {}]
              }
