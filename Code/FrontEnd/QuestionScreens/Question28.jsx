...
const Question28 = ({ navigation }) => 
  {
    const [selectedGoal, setSelectedGoal] = useState(null);
    const { saveAnswer } = useAnswers();
    const totalQuestions = 31; 
    const currentQuestion = 28;

    const bodyGoalOptions = 
      [
          { label: 'Two times (breakfast and dinner)', value: '2', image: require('../Images/meal.png') },
          { label: 'Three times (breakfast, lunch, and dinner)', value: '3', image: require('../Images/meal.png') },
          { label: 'Four times (breakfast, snack, lunch, and dinner)', value: '4', image: require('../Images/meal.png') },
          { label: 'Five times (breakfast, lunch, dinner, and 2 snacks)', value: '5', image: require('../Images/meal.png') },
    ...
    const handleSubmit = () => 
      {
          if (selectedGoal) 
              {
                saveAnswer(28, selectedGoal);
                navigation.navigate('Question29'); 
              } 
          else 
              {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          <Text style={styles.questionText}>How many times a day do you want to eat?</Text>
