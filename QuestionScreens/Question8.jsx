...
const Question8 = ({ navigation }) => 
    {
        ...
        const options = 
            [
                { label: 'I\'m so out of breath I can\'t talk 🥵', value: '1' },
                { label: 'I\'m somewhat out of breath but can talk 😮‍💨', value: '2' },
                { label: 'I\'m OK after one flight of stairs 🙂', value: '3' },
                { label: 'I can easily walk up a few flights of stairs 🚀', value: '4' },
            ];
